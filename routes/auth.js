...
const client = new OAuth2Client("38978370330-59irb4a2dl3b7v3jrt7ncq2de5ali816.apps.googleusercontent.com");
...
router.post('/googlelogin', async (req, res) => {
    ...
    try {
        ...
        const ticket = await client.verifyIdToken({
            idToken: token,
            audience: "38978370330-59irb4a2dl3b7v3jrt7ncq2de5ali816.apps.googleusercontent.com",
        });
...
router.route('/resetpassword/:token')
  .get(async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Token is valid. Proceed to reset your password.' });
    } catch (error) {
        console.error(error.message);
...
async function sendResetEmail(email, resetLink) {
    const transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: 'hh0449901@gmail.com', // Replace this with your real email
            pass: 'tpqr mhsc glnf xiju',  // Or app-specific password
        },
    });
